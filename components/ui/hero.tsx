...
export const PremiumHero = ({ className }: { className?: string }) => {
      ...
      <div className="relative z-20 flex h-full w-full items-center justify-center px-6 text-center">
        <div className="container mx-auto flex flex-col items-center gap-12 text-center">
          <Button variant="secondary" size="sm" className="gap-4">
            Support for AI Models <MoveRight className="h-4 w-4" />
          </Button>

          <h1 className="max-w-2xl text-5xl tracking-tighter text-white md:text-7xl">
            <span>This is AI Power</span>
          ...
          <p className="max-w-2xl text-center text-lg leading-relaxed tracking-tight text-slate-300 md:text-xl">
            Highly customizable components for building modern websites and applications that look and feel the way
            you mean it.
          </p>

          <div className="flex flex-row flex-wrap justify-center gap-3">
            <Button size="sm" className="gap-4" variant="outline">
              Explore UI CAT <MoveRight className="h-4 w-4" />
            </Button>
            <Button size="sm" className="gap-4" variant="default">
